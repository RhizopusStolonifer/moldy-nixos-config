{ inputs, ... }:
{
  ...
  xdg.configFile."niri/dms/windowrules.kdl".source = ./dms/outputs.kdl;
  xdg.configFile."niri/dms/windowrules.kdl".source = ./dms/wpblur.kdl;
  xdg.configFile."niri/dms/windowrules.kdl".source = ./fw12_binds.kdl;
  xdg.configFile."niri/dms/windowrules.kdl".source = ./mycorrhiza_binds.kdl;
}
